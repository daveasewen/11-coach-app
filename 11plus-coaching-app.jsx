...
const VOCAB_BANK = [
  ...
  { word: "bewildered", definition: "Perplexed and confused; baffled", simpleDefinition: "So confused you don't know what is going on", synonyms: ["confused", "perplexed", "baffled", "puzzled"], antonyms: ["clear-headed", "certain", "composed"], difficulty: 2, pos: "adjective", example: "He was bewildered by the complex instructions." },
  ...
  { word: "dilapidated", definition: "In a state of disrepair or ruin", simpleDefinition: "Old and falling apart — needs lots of fixing", synonyms: ["rundown", "crumbling", "decrepit", "derelict"], antonyms: ["well-maintained", "pristine", "new", "renovated"], difficulty: 3, pos: "adjective", example: "The dilapidated cottage had not been lived in for years." },
  ...
  { word: "perplexed", definition: "Completely baffled; bewildered", simpleDefinition: "Really confused and not sure what's going on", synonyms: ["baffled", "puzzled", "confused", "bewildered"], antonyms: ["clear", "understanding", "composed"], difficulty: 2, pos: "adjective", example: "She was perplexed by the strange riddle." },
  ...
  { word: "gaunt", definition: "Extremely thin and bony through hunger or illness", simpleDefinition: "Very thin and bony — looks unhealthy", synonyms: ["thin", "haggard", "emaciated", "hollow-cheeked"], antonyms: ["plump", "healthy-looking", "robust"], difficulty: 3, pos: "adjective", example: "After weeks without food, the survivors looked gaunt." },
  ...
  { word: "derelict", definition: "In poor condition through neglect; abandoned", simpleDefinition: "Left to fall apart — abandoned and in very poor condition", synonyms: ["abandoned", "dilapidated", "neglected", "rundown"], antonyms: ["maintained", "cared-for", "pristine"], difficulty: 3, pos: "adjective", example: "The derelict factory had been empty for decades." },
