...
Read `session-handover-2026-05-17d.md` in the 11+ coach app folder before doing anything else. That is the current state of the project.

**Project**: 11+ coaching app (Kent/Bexley). Single-file React/JSX app assembled into `11plus-coach.html`. Current version: v1.13.0.
